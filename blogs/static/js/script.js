(function($) {
    ...
    var dialog = document.getElementById('custom-alert-dialog');
    var messageElement = document.getElementById('custom-alert-message');
  ...
  $(document).ready(function() {
    ...
    $('#subscriptionForm').submit(function(event) {
        ...
        $.ajax({
            url: '{% url "home" %}',  // Update with your URL
            method: 'POST',
            data: formData,
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    $('#success_fail_info').html('<div class="alert alert-success">Email saved successfully.</div>');
                } else {
                    // Display error message
                    $('#success_fail_info').html('<div class="alert alert-danger">' + response.message + '</div>');
                }
            },
            error: function(xhr, status, error) {
                // Display error message
                $('#success_fail_info').html('<div class="alert alert-danger">An error occurred. Please try again.</div>');
            }
        });
    });
});
